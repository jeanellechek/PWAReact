    ...
    return (
      <div>
        <p className="titleBold">
          ...
          <input type="text" placeholder="E.g name@email.com" className="onBoardTextbox titleBold" id="muted" />
        </p>

        <p className="titleBold">
          Active<br />
          <input type="text" placeholder="E.g name@email.com" className="onBoardTextbox titleBold" id="active" />
        </p>

        <p className="titleBold">
          Error State<br />
          <input type="text" placeholder="E.g name@email.com" id="errorInput" onChange={this.validateInput.bind(this)} className="onBoardTextbox titleBold" /><br />
          {(errorMsg === true) ? <label className="error" id="error">Hmm... It doesn't seem right.</label> : null}
        </p>

        <p className="titleBold">
          Disabled Input<br />
          <input type="text" placeholder="E.g name@email.com" className="onBoardTextbox titleBold  opacity30" disabled />
        </p>
      </div>
    )
  }
